...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_mm_interconnect_0_rsp_demux_001.sv \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_mm_interconnect_0_rsp_demux.sv \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_mm_interconnect_0_cmd_mux_001.sv \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_mm_interconnect_0_router_003.sv \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_nios2_gen2_0_cpu.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_nios2_gen2_0_cpu_debug_slave_sysclk.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_nios2_gen2_0_cpu_debug_slave_tck.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_nios2_gen2_0_cpu_debug_slave_wrapper.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_nios2_gen2_0_cpu_test_bench.v \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_timer_0.v \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/sha256.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/sha256_core.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/sha256_k_constants.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/sha256_w_mem.v \
